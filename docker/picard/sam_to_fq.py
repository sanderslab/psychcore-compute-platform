...
def main():
    ...
    in_files = [os.environ['in_file']]

    start_time = datetime.now()
    print("SAM TO FQ for {} was started at {}.".format(prefix, str(start_time)))
    ...
    print("SAM TO FQ for {} ended at {}.".format(prefix, str(end_time)))
    total_time = end_time - start_time
    print("Total time for SAM TO FQ was {}.".format(str(total_time)))
